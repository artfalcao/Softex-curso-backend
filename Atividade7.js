...
ALGORITMO
  ...
  nome caractere;
  nota real;
  contador, numAprovados1, numAprovados2, numAprovados3, numAprovados4, numTotalAprovados maiorNota1, maiorNota2, maiorNota3, maiorNota4, maiorNotaGeral, turma inteiro;
...
INICIO
  ...
  SE (turma == 1) ENTAO
    ...
    PARA contador = 0; contador < 25 ; contador + 1
